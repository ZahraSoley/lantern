...
export default function Lantern({ gameStatus }: gameType) {
  ...
  return (
    <div className="md:mb-[-20px] md:m-15 w-60 h-60 md:scale-125 lg:scale-140 rounded-full flex justify-center items-center overflow-hidden">
      <motion.div
